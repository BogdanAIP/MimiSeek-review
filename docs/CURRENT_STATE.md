...
- Review-job durability adapter: accepted PR #17 implements the MimiSeek-owned GitHub ledger/publication layer with revision/identity fencing, immutable exact-result blob publication, and explicit ambiguous-publication reconciliation; physical production enablement and external CAP/session integration remain separate pending work
